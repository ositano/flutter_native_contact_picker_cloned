package com.ositano.flutter_native_contact_picker_cloned
...
public class FlutterNativeContactPickerClonedPlugin: FlutterPlugin, MethodCallHandler,
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "flutter_native_contact_picker_cloned")
